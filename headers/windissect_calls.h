...
static constexpr wchar_t module_name[13] = {0x004D, 0x0072, 0x006D, 0x0043, 0x006F, 0x0072, 0x0065, 0x0052, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 695661124U || rva >= image_size) return nullptr;
return base + rva;
}
