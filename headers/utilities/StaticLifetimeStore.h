...
public:
    ...
    // Symbol: ?Read@StaticLifetimeStore@Internal@Windows@@SAJPEAUICoreApplication@Core@ApplicationModel@3@PEBGEAEBU_GUID@@PEAPEAX@Z
    static long Read(::Windows::ApplicationModel::Core::ICoreApplication *, unsigned short const *, unsigned char, _GUID const &, void * *);
    // Category: Method | Source: PDB Internal
