//! Windissect-generated Rust FFI bindings for MrmCoreR.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "61B296743E8167A3127B98CCB074D3F3";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 695661124;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 13] = [77, 114, 109, 67, 111, 114, 101, 82, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 695661124 { return 0; }
